...
void BodyGeometry::ComputeGeometryTask(BodyPose * angles, BodyParameters * params)
{
	...
	DMatrixf thoraxTpelvis(0, angles->get(26), angles->get(27), ANGLE_DECOMPOSITION_ORDER);
	...
	DMatrixf lshoulderTlclavicle(angles->get(16), angles->get(17), angles->get(18), ANGLE_DECOMPOSITION_ORDER);
	...
	DMatrixf rshoulderTrclavicle(angles->get(22),angles->get(23),angles->get(24),ANGLE_DECOMPOSITION_ORDER);
