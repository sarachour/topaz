...
indep = ["nored","redlike","redunlike"]
labels = ["No Reduction", "Reduce Like", "Reduce Unlike"]		
xaxis="Reduction Performed"
title="Effect of Degree of Reduction on Selection"
produce_tuple_plot("tradeoff_reduction",title,"reduce",indep,labels,xaxis,True)


indep = ["batch1","batch2","batch4","batch8","batch16"]
labels = ["1", "2", "4","8", "16"]
