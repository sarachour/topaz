...
configure_flags = '-DG_DISABLE_CAST_CHECKS -pthread -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pango-1.0 -I/usr/include/libxml2 -I/usr/include/libpng12 -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/include/freetype2        -lpng12    -lz -ljpeg -pthread -lgthread-2.0 -lglib-2.0   -Wl,--export-dynamic -pthread -lgmodule-2.0 -lxml2 -lgobject-2.0 -lglib-2.0   -lpangoft2-1.0 -lpango-1.0 -lfontconfig -lgobject-2.0 -lglib-2.0 -lfreetype          -lm -I../../libvips/include -I../../libvipsCC/include'
...
def make_extension (name, source):
	return Extension (name, 
					 ...
					 runtime_library_dirs= ['/mnt/hgfs/sachour/Documents/git/research/topaz/benchmarks/vips/src/bin/lib'])
